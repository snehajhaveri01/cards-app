...
// import { resetChartData } from "../redux/chartSlice"; 
...
//             <button className="rounded-md bg-amber-800 px-5 py-2.5 text-sm font-medium text-white shadow" onClick={handleReset}>
//                     Reset Chart
//             </button>
//         </div>
//     </>
    ...
    return (
      <div className="flex">
        ...
        <div className="flex-1 pl-4">
          <div className="mt-4">
            <label htmlFor="newValue" className="block text-sm font-medium text-gray-600">
              Add new label:
            </label>
            <input
              type="text"
